...
const HomePage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        await axios.get(`http://localhost:7000/filterImportData?${ivalue}=${query}`)
        ...
        <>
            <div className='d-flex align-items-center justify-ontent-center flex-column  bg-warning ' style={{ height: "30vh", backgroundImage: new URL("https://img.freepik.com/free-photo/aerial-view-container-cargo-ship-sea_335224-735.jpg?w=996&t=st=1691716989~exp=1691717589~hmac=979a18b03faffdfdee3aa46aad4267764212b4b662aa0d818c5a610b96123b3e") }}>
                <div className=' mt-3 d-flex align-items-center justify-ontent-center'>
                    <h2 className='mb-2 d-flex align-items-center justify-ontent-center'>Search Import Export Data Of India</h2>
                </div>

                <div className='mt-5 d-flex align-items-center justify-ontent-center'>
                    <input className=" fs-1 " type="radio" value="RITC" name="data" onChange={e => setValue(e.target.value)} />RITC
                    <input className="fs-1 ms-3 " type="radio" value="RITC_DESCRIPTION" name="data" onChange={e => setValue(e.target.value)} />RITC_DESCRIPTION
                </div>

                <div className='mb-3 mt-5'>
                    <form onSubmit={handleSubmit} className="d-flex align-items-center justify-content-center mb-3">
                        <input className="" style={{ display: "inline-block", height: "30px", width: "40vw", border: "none" }} type='text' placeholder='RITC/RITC_DESCRIPTION' value={query} onChange={e => setQuery(e.target.value)} />
            ...
            <div className='container '>
                <div>
                    <h1 className='mt-3 d-flex align-items-start'>Detailed Import Data of match with {ivalue} {getImportData.length}</h1>
                </div>
